...
const WRITER = {
  ...
  role: "יוצרת רב־תחומית · שירה · סיפורת · כתיבה למוזיקה",
  excerpt:
    "״כל שיר הוא דלת, וכל סיפור הוא חדר שמעבר לה. אני רק מחזיק את המפתח.״",
  bio: [
    "מאיה אלקבץ היא יוצרת רב־תחומית הכותבת שירה, סיפורת קצרה ומילים לשירים. יצירתה נעה בין השקט הפנימי של השיר הקצר לבין המרחב הסיפורי הרחב, ומתעניינת בעיקר במה שקורה בין המילים — בהפסקות, בנשימות, ובמה שלא נאמר.",
    "פרסמה יצירות בכתבי עת עצמאיים, שיתפה פעולה עם מלחינים ומוזיקאים, ומלווה סדנאות כתיבה יוצרת. כיום עובדת על קובץ סיפורים ראשון ועל אלבום מילים שכתבה במיוחד לליווי מוזיקלי.",
  ],
};
          ...
          <div className="grid md:grid-cols-3 gap-10 mb-14">
            ...
            <div>
              ...
              <div className="flex gap-4">
                {["Instagram", "Facebook", "SoundCloud"].map((s) => (
                  <a
                    key={s}
                    href="#"
